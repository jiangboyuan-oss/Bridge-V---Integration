...
contract Destination is AccessControl {
    ...
    function unwrap(address _wrapped_token, address _recipient, uint256 _amount ) public {
        ...
        // Burn the wrapped tokens from the user calling the function
        // BridgeToken overrides burnFrom to allow MINTER_ROLE (this contract) to burn without allowances
    ...
    function createToken(address _underlying_token, string memory name, string memory symbol ) public onlyRole(CREATOR_ROLE) returns (address) {
        ...
        // Pass address(this) as the admin so this Destination contract gets MINTER_ROLE
